...
/**
 * This class conforms to the JSON Web Key (JWK) format as defined here:
 * https://tools.ietf.org/html/rfc7517#section-4 It's purpose is to allow us to
 * easily serialize out a JWK for client-side use by the WebCryptoApi.
 */
